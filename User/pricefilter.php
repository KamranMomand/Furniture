            ...
            <div class="page-content mb-10">
                <div class="container">
                    ...
                    <div class="shop-content toolbox-horizontal">
                              ...
                              <table style="width: 100% ;">
                                <tbody >
                                    <tr >
                                        ...
                                        <td > 
                                        <a href="pricefilter.php?priceids=1&priceide=50" <?php if($srange == 1 && $erange == 50){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$0.00 - $50.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=50&priceide=100" <?php if($srange == 50 && $erange == 100){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$50.00 - $100.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=100&priceide=200" <?php if($srange == 100 && $erange == 200){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$100.00 - $200.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=200&priceide=400" <?php if($srange == 200 && $erange == 400){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$200.00 - $400.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=400&priceide=500" <?php if($srange == 400 && $erange == 500){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$400.00 - $500.00</a>
                                        </td>
                                        <td>
                                            <a href="pricefilter.php?priceids=500&priceide=100000000000" <?php if($srange == 500 && $erange == 100000000000){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$500.00+</a>
                                        </td>
                                        <td>
                                            <a href="allproducts.php" class="">Clear All</a>
                                        </td>
                                    </tr>
                        ...
                        <?php
                            $aproquery = "select * from `product` p join `sub_category` sc on p.pro_subcat=sc.subcat_id join `category` c on sc.category=c.cat_id join `main_category` mc on c.main_category=mc.maincat_id join `pro_badge` pb on p.pro_badge=pb.badge_id join `pro_warrenty` pw on p.pro_warranty=pw.warren_id where p.pro_price > '$srange' AND p.pro_price < '$erange' AND `pro_status` = 'Active'";
