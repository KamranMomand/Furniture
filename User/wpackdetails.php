...
if (isset($_GET['id'])) {
    include 'config.php';
    $id = $_GET['id'];
    $pdetquery = "select * from `wedding_packages` wp join `pro_badge` pb on wp.pro_badge=pb.badge_id join `pro_warrenty` pw on wp.pro_warrenty=pw.warren_id where wp.wpack_id='$id'";
                        ...
                        <div class="main-content">
                            <div class="product product-single row mb-2">
                                    ...
                                    <div class="product-gallery product-gallery-sticky">
                                        <div class="swiper-container product-single-swiper swiper-theme nav-inner" data-swiper-options="{
                                            ...
                                            <div class="swiper-wrapper row cols-1 gutter-no">
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($pdetrow['wpack_img1']); ?>"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($pdetrow['wpack_img2']); ?>"
                                                ...
                                                <div class="swiper-slide">
                                                    <figure class="product-image">
                                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($pdetrow['wpack_img3']); ?>"
                                            ...
                                            <div class="product-label-group">
                                                <label class="product-label label-hot"><?php echo $pdetrow['badge_name']; ?></label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 mb-4 mb-md-6">
                                    <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                        <h1 class="product-title"><?php echo $pdetrow['wpack_name']; ?></h1>
                                        <div class="product-bm-wrapper">
                                            ...
                                            <div class="product-meta">
                                                ...
                                                <div class="product-categories">
                                                    Warrenty:
                                                    <span class="product-category"><span><?php echo $pdetrow['warren_duration']; ?></span></span>
                                                </div>
                                                <div class="product-sku">
                                                    SKU: <span><?php echo $pdetrow['wpack_code']; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">$<?php echo $pdetrow['wpack_price']; ?></ins><del class="old-price">$<?php echo $pdetrow['wpack_cross_price']; ?></del>
                                        </div>

                                        <div class="product-countdown-container">
                                            <label class="mr-2">Stock Count:</label>
                                            <div>
                                                <?php echo $pdetrow['wpack_quantity']; ?></div>
                                        </div>

                                        <div class="ratings-container" >
                                                    <?php
                                                    $queryra3 = "select * from `wedding_rating` WHERE `wpack_id` = '$id' ORDER BY `wrating_id` DESC LIMIT 1";
                                                    $resultra3 = mysqli_query($conn, $queryra3);
                                                    $countra3 = mysqli_num_rows($resultra3);
                                                    $rafetch3 = mysqli_fetch_assoc($resultra3);

                                                    $queryra4 = "select * from `wedding_rating` WHERE `wpack_id` = '$id'";
                                                    ...
                                                    ?>
                                                                    <fieldset class="rate2" >
                                                                        <input type="radio" class="getinput2" 
                                                                            <?php if($rafetch3['wrating'] == "5"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        ...
                                                                        <input type="radio" class="getinput2"
                                                                            ...
                                                                            <?php if($rafetch3['wrating'] == "4"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        ...
                                                                        <input type="radio" class="getinput2"
                                                                            ...
                                                                            <?php if($rafetch3['wrating'] == "3"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        ...
                                                                        <input type="radio"  class="getinput2"
                                                                            ...
                                                                            <?php if($rafetch3['wrating'] == "2"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        ...
                                                                        <input type="radio" class="getinput2"
                                                                            ...
                                                                            <?php if($rafetch3['wrating'] == "1"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        ...
                                                                        <input type="radio" class="getinput2"
                                                                            ...
                                                                            <?php if($rafetch3['wrating'] == "0.5"){ ?>
                                                                            checked <?php } ?> disabled />
                                                                        <label class="half2 s12" for="rating11"
                                                                            title="1/2 star"></label>

                                                                        <input type="radio" class="getinput2"
                                                                            <?php if($rafetch3['wrating'] == "0"){ ?> checked
                                                                            <?php } ?> disabled />
                                        ...
                                        <div class="product-short-desc">
                                            <ul class="list-type-check list-style-none">
                                                ...
                                                <?php 
                                                $data = $pdetrow['wpack_description'];
                                        ...
                                        <div class="fix-bottom product-sticky-content sticky-content">
                                            <div class="product-form container">
                                                ...
                                                <button class="btn btn-primary btn-cart btncart" value="<?php echo $pdetrow['wpack_id']; ?>">
                            ...
                            <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <?php
                                        $prod_idddd = $_GET['id'];
                                        $queryfc = "select * from `wedding_rating` WHERE wpack_id='$prod_idddd'";
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-12 mb-5">
                                                ...
                                                <ul class="list-type-check">
                                                    <li><?php echo $pdetrow['wpack_description']; ?>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <?php
                                    $queryra5 = "select * from `wedding_rating` WHERE `wpack_id` = '$id'";
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="show-all">
                                                <ul class="comments list-style-none">
                                                    ...
                                                    <?php
                                                    $prod_iddd = $_GET['id'];
                                                    $queryf = "select * from `wedding_rating` wr join `wedding_packages` wp on wr.wpack_id=wp.wpack_id join `user` u on wr.user_id=u.user_id WHERE wr.wpack_id='$prod_iddd'";
                                                        ...
                                                        <div class="comment-body">
                                                            ...
                                                            <div class="comment-content">
                                                                <h4 class="comment-author">
                                                                    <a><?php echo $rowf['wrating_name'] ?></a>
                                                                    <span
                                                                        class="comment-date"><?php echo $rowf['wrating_date'] ?>
                                                                        at
                                                                        <?php echo $rowf['wrating_time'] ?></span>
                                                                </h4>

                                                                <div class="ratings-container comment-rating">
                                                                    <fieldset class="rate2">
                                                                        <input type="radio" class="getinput2" 
                                                                            <?php if($rowf['wrating'] == "5"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        <label class="s12" for="rating101"
                                                                            title="5 stars"></label>
                                                                        ...
                                                                        <input type="radio" class="getinput2"
                                                                            ...
                                                                            <?php if($rowf['wrating'] == "0.5"){ ?>
                                                                            checked <?php } ?> disabled />
                                                                        <label class="half2 s12" for="rating11"
                                                                            title="1/2 star"></label>

                                                                        <input type="radio" class="getinput2"
                                                                            <?php if($rowf['wrating'] == "0"){ ?> checked
                                                                            <?php } ?> disabled />
                                                                        <label class="s12" for="rating10"
                                                                            title="No star"></label>
                                            ...
                                            <div class="tab-pane" id="highest-rating">
                                                ...
                                                <?php
                                                    $prod_iddd = $_GET['id'];
                                                    $queryf = "select * from `wedding_rating` wr join `wedding_packages` wp on wr.wpack_id=wp.wpack_id join `user` u on wr.user_id=u.user_id WHERE wr.wpack_id='$prod_iddd' AND wr.wrating >= '4'";
                                                    $resultf = mysqli_query($conn, $queryf);
                                                    $countf = mysqli_num_rows($resultf);
                                                    $nofeedback = NULL;
                                                    if ($countf > 0) {
                                            ...
                                            <div class="tab-pane" id="lowest-rating">
                                                ...
                                                <?php
                                                    $prod_iddd = $_GET['id'];
                                                    $queryf = "select * from `wedding_rating` wr join `wedding_packages` wp on wr.wpack_id=wp.wpack_id join `user` u on wr.user_id=u.user_id WHERE wr.wpack_id='$prod_iddd' AND wr.wrating <= '3'";
                                                    $resultf = mysqli_query($conn, $queryf);
                                                    $countf = mysqli_num_rows($resultf);
                                                    $nofeedback = NULL;
                                                    if ($countf > 0) {
                            ...
                            <section class="related-product-section">
                                <div class="title-link-wrapper mb-4">
                                    ...
                                    <a href="allproducts.php" class="btn btn-dark btn-link btn-slide-right btn-icon-right">More
                                ...
                                <?php
                            $rpquery = "select * from `wedding_packages` wp join `pro_badge` pb on wp.pro_badge=pb.badge_id join `pro_warrenty` pw on wp.pro_warrenty=pw.warren_id";
                        ...
                        ?>
                                        ...
                                        <div class="swiper-slide product">
                                            <figure class="product-media">
                                                <a href="wpackdetails.php?id=<?php echo $rprow['wpack_id']; ?>">
                                                    <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($rprow['wpack_img1']); ?>" alt="Product"
                                                ...
                                                <div class="product-action">
                                                    <a href="wpackdetails.php?id=<?php echo $rprow['wpack_id']; ?>" class="btn-product " title="Quick View">Quick
                                                        View</a>
                                                </div>
                                            </figure>
                                            <div class="product-details">
                                                <h4 class="product-name"><a href="wpackdetails.php?id=<?php echo $rprow['wpack_id']; ?>"><?php echo $rprow['wpack_name']; ?></a></h4>
                                                <div class="ratings-container">
                                                    <div class="ratings-full">
                                                        <span class="ratings" style="width: 100%;"></span>
                                                        <span class="tooltiptext tooltip-top"></span>
                                                ...
                                                <div class="product-pa-wrapper">
                                                    <div class="product-price">$<?php echo $rprow['wpack_price']; ?></div>
                                                </div>
                                            </div>
                                        </div>
