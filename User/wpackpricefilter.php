<?php
if (isset($_GET['priceids'])) {
    $srange = $_GET['priceids'];
    $erange = $_GET['priceide'];
?>
  ...
  <table style="width: 100% ;">
    <tbody >
        <tr >
            ...
            <td > 
            <a href="wpackpricefilter.php?priceids=1&priceide=50" <?php if($srange == 1 && $erange == 50){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$0.00 - $50.00</a>
            </td>
            <td>
            <a href="wpackpricefilter.php?priceids=50&priceide=100" <?php if($srange == 50 && $erange == 100){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$50.00 - $100.00</a>
            </td>
            <td>
            <a href="wpackpricefilter.php?priceids=100&priceide=200" <?php if($srange == 100 && $erange == 200){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$100.00 - $200.00</a>
            </td>
            <td>
            <a href="wpackpricefilter.php?priceids=200&priceide=400" <?php if($srange == 200 && $erange == 400){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$200.00 - $400.00</a>
            </td>
            <td>
            <a href="wpackpricefilter.php?priceids=400&priceide=500" <?php if($srange == 400 && $erange == 500){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$400.00 - $500.00</a>
            </td>
            <td>
            <a href="wpackpricefilter.php?priceids=500&priceide=100000000000" <?php if($srange == 500 && $erange == 100000000000){ ?> style="background-color: #d9ebff"<?php } ?> class="btn price">$500.00+</a>
            </td>
            <td>
            <a href="weddingpackages.php" class="">Clear All</a>
            </td>
        </tr>
    </tbody>
   </table> 
   <br/>
                        ...
                        <?php
                            $aproquery = "select * from `wedding_packages` wp join `pro_badge` pb on wp.pro_badge=pb.badge_id join `pro_warrenty` pw on wp.pro_warrenty=pw.warren_id where wp.wpack_price > '$srange' AND wp.wpack_price < '$erange' AND wp.wpack_status = 'Active'";
...
<?php 
    ...
    header('location: weddingpackages.php');
}
?>