...
<!-- Mirrored from portotheme.com/html/wolmart/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2022 22:35:51 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="container">
                    ...
                    <section class="count-section mb-10 pb-5">
                        ...
                        <?php
                            ...
                            $psquery="select * from `pro_order`";
                            $psresult=mysqli_query($conn,$psquery);
                            $pscount = mysqli_num_rows($psresult);

                            $lquery="select * from `team`";
                            ...
                            <div class="swiper-wrapper row cols-lg-3 cols-md-2 cols-1">
                                <div class="swiper-slide counter-wrap">
                                    <div class="counter text-center">
                                        <span class="count-to" data-to="<?php echo $pscount ;?>">0</span>
                                        <span>M+</span>
                                ...
                                <div class="swiper-slide counter-wrap">
                                    <div class="counter text-center">
                                        <span>$</span>
                                        <span class="count-to" data-to="<?php echo $lcount ;?>">0</span>
                                        <span>B+</span>
                                        <h4 class="title title-center">Our Leaders</h4>
                                        <p>Diam maecenas ultricies mi eget mauris<br>
                                            Nibh tellus molestie nunc non</p>
                                    </div>
                                </div>
                                <div class="swiper-slide counter-wrap">
                                    <div class="counter text-center">
                                        <span class="count-to" data-to="<?php echo $ucount ;?>">0</span>
                                        <span>M+</span>
                    ...
                    <div class="container mt-10 mb-9">
                        <div class="row align-items-center mb-10">
                            ...
                            <div class="col-md-6 pl-lg-8 mb-8">
                                ...
                                <a href="allproduct.php" class="btn btn-dark btn-rounded">Visit Our Store</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-container swiper-theme" data-swiper-options="{
                            ...
                            ?>     
                                <div class="swiper-slide member-wrap">
                                    <figure class="br-lg">
                                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['team_profile']);?>" alt="Member" width="295" height="332" />
                                        
                                    </figure>
                                    <div class="member-info text-center">
                                        <h4 class="member-name"><?php echo $row['team_name'];?></h4>
                                        <p class="text-uppercase"><?php echo $row['team_designation'];?></p>
                                    </div>
                                </div>
                            <?php } ?>
                            </div>
