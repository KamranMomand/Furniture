            ...
            <div class="page-content mb-10">
                <div class="container">
                                        ...
                                        <figure class="category-media">
                                            <a href="maincatproduct.php?id=<?php echo $acrow[0] ?>">
                                                <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($acrow['maincat_image']); ?>" alt="Categroy"
                                                    width="190px" height="280px" style="background-color: #5C92C0;" />
                                            </a>
                                        </figure>
                    ...
                    <div class="shop-content toolbox-horizontal">
                              ...
                              <table style="width: 90% ;">
                                <tbody >
                                    <tr >
                                        ...
                                        <td > 
                                        <a href="pricefilter.php?priceids=1&priceide=50" class="btn price">$0.00 - $50.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=50&priceide=100" class="btn price">$50.00 - $100.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=100&priceide=200" class="btn price">$100.00 - $200.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=200&priceide=400" class="btn price">$200.00 - $400.00</a>
                                        </td>
                                        <td>
                                        <a href="pricefilter.php?priceids=400&priceide=500" class="btn price">$400.00 - $500.00</a>
                                        </td>
                                        <td>
                                            <a href="pricefilter.php?priceids=500&priceide=100000000000" class="btn price">$500.00+</a>
                                        </td>
                                    </tr>
                                </tbody>
                               </table> 
                        ...
                        <?php
                            $aproquery = "select * from `product` p join `sub_category` sc on p.pro_subcat=sc.subcat_id join `category` c on sc.category=c.cat_id join `main_category` mc on c.main_category=mc.maincat_id join `pro_badge` pb on p.pro_badge=pb.badge_id join `pro_warrenty` pw on p.pro_warranty=pw.warren_id where p.pro_status = 'Active'";
