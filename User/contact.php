...
<main class="main">
                        ...
                        <div class="row gutter-lg pb-3">
                            ...
                            <div class="col-lg-6 mb-8">
                                ...
                                <div class="contact-us-form">
                                    ...
                                    <button type="submit" id="btncontact" class="btn btn-dark btn-rounded">Send Now</button> &nbsp; <span style="color: #336699 ;" id="cemsg"></span>
                            </div>
                            </div>
                        </div>
                    </section>
        ...
        success:function(response){
            ...
            {
                var err="Your Message Has Not Been Sent. Try Again!";
            }
        },
        error:function(err)
        {
