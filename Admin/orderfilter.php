        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card-box table-responsive">
                        ...
                        <table style="width: 60% ;">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                    <a href="order.php" style="color: #336699 ; font-weight: 500;">Clear All</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <?php
                        if($statusf == "All Orders"){
                            $or_query="SELECT * from `pro_order`";
                            $or_result=mysqli_query($conn,$or_query);  
                            $or_count = mysqli_num_rows($or_result);
                        }else{
                            $or_query="SELECT * from `pro_order` where `order_status` = '$statusf'";
                            $or_result=mysqli_query($conn,$or_query);  
                            $or_count = mysqli_num_rows($or_result);
                        }
                        ...
                        <?php
                            ...
                            <h5>There are no orders of this status.</h5>
